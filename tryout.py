...
model = PPO2.load("c:\\tmp\\roxenv_sh\\traning_data\\trader_lstm_48_env_4_iter_8")

obs = asd.reset()
_state = None
rewards = list()
for i in range(2340390):
    ...
    if action[0] == 2:
        ...
        if (reward[0] != 0.0):
            rewards.append(str(reward[0]))


with open('c:\\tmp\\roxenv_sh\\traning_data\\trader_balance_reward_lstm_48_env_4_iter_20.json', 'w') as fp:
